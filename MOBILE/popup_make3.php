      ...
      <div class="pics frame_1">
        ...
        <div class="inner_pics">
          ...
          <div class="pc_frame">
            ...
            <div class="text f_3_2" id="imsi_caption2">자막</div>
            <div class="p_img f_3_2" id="user_img2">이미지</div><!--소비자 합성 이미지-->
            <div class="front_img img"><img src="images/popup/img_frm_3_2.png" id="user_ex_img2" /></div>
            <div class="bg img"><img src="images/popup/frm_b_bg.jpg" /></div>
          </div>
          <div class="pic_input">
      ...
      <div class="pics frame_1">
        ...
        <div class="inner_pics">
          ...
          <div class="pc_frame">
            ...
            <div class="name f_3_2 imsi_caption_baby"></div>
            <div class="text f_3_2" id="imsi_caption3">자막</div>
      ...
      <div class="pics frame_1">
        ...
        <div class="inner_pics">
          ...
          <div class="pc_frame">
            ...
            <div class="text f_3_4" id="imsi_caption4">자막</div>
            <div class="p_img f_3_4" id="user_img4">예시 이미지</div><!--소비자 합성 이미지-->
            <div class="front_img img"><img src="images/popup/img_frm_3_2.png" id="user_ex_img4" /></div>
            <div class="bg img"><img src="images/popup/frm_b_bg.jpg" /></div>
          </div>
          <div class="pic_input">
            ...
            <div class="block_content movie">
            	<div class="inner">
                	...
                	<div class="mv">
                        ...
                        <div class="youtube">
                        	<video src="../files/out.mp4" controls preload="auto" id="video_player" poster="scene/concept_3_1.jpg"></video>
                        </div>
                    </div>
<?
	if ($iPhoneYN == "N")
        ...
        if (file.preview) {
            node
				...
				if (uimg3_w > uimg3_h)
				{
					...
					$("td#user_img3 > div > p > canvas").css("height",user_ex_img3+"px");
