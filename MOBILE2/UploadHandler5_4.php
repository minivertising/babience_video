...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        $this->options = array(
            ...
            //'upload_dir' => '../files/'.$_SESSION['ss_serial'].'/',
            //'upload_url' => '../files/'.$_SESSION['ss_serial'].'/',
            'upload_dir' => '../files2/'.$_REQUEST['s_id'].'/',
            'upload_url' => '../files2/'.$_REQUEST['s_id'].'/',
            //'upload_dir' => '../files/',
            //'upload_url' => '../files/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
    ...
    protected function trim_file_name($file_path, $name, $size, $type, $error,
		...
		if ($namearr[$arr_num] == "jpeg" || $namearr[$arr_num] == "JPEG")
			$namearr[$arr_num]	= "jpg";
		$name	= $_REQUEST['s_id']."_5.".strtolower($namearr[$arr_num]);
		//$name	= date("YmdHis").".".$namearr[1];
		//$ssl_name = stripslashes($name);
		//$namearr	= substr($ssl_name,-3);
		//$name	= $_SESSION['mb_phone'].".".$namearr;
        // Use a timestamp for empty filenames:
        if (!$name) {
            $name = str_replace('.', ".\x00..\x20", microtime(true));
        }
        return $name;
    }
